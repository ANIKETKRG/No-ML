...
class QDMGraphicsNode ( QGraphicsItem ) :
    ...
    def __init__( self , node , parent = None ) :
        ...
        # self._pen_title = QPen ( QColor ( "#FF313131" ) )
    ...
    def initContent ( self ) :
        ...
        # self.grContent.setFlag(QGraphicsItem.ItemIsMovable, False)
    ...
    def paint ( self , painter , QStyleOptionGraphicsItem , widget = None ) :
        ...
        path_content.addRect ( self.width - self.edge_size , self.title_height , self.edge_size , 
                              self.edge_size )
        painter.setPen ( Qt.NoPen )
